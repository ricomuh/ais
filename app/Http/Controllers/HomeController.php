...
class HomeController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $ytVideo = cache()->remember('ytVideo', 60 * 60 * 6, function () {
            return Http::get('https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCikrCm-sl0pauu4tTtBqIXw&maxResults=1&order=date&key=AIzaSyDhViTqsxB6CRrj9P8mAvo1RPshbgI2uPI')->collect();
        });
