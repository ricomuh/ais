...
<x-page-layout :title="$staff->name">
    ...
    <div class="flex flex-col md:flex-row gap-8">
        <div class="w-full md:w-1/4 animate" data-animate="animate-from-left">
            <img src="{{ asset('img/staff/' . $staff->photo) }}" alt="" class="w-full rounded-full shadow-md border-4 border-secondary">
        </div>
