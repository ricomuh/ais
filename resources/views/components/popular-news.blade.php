<div class="flex flex-col space-y-4">
    ...
    <form action="{{ route('news.search') }}" method="get" class="flex space-x-2">
        ...
        <button type="submit" class="bg-primary text-secondary hover:bg-primary-light hover:text-secondary-light focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-primary px-2 md:px-4 py-1 text-sm rounded-md transition duration-300 flex-shrink-0">Search <i class="fas fa-search"></i></button>
    </form>
